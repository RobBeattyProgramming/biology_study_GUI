...
questionOneAnswerOne = Checkbutton(root, text = questionOneInfo[0], variable=qOneAOne, onvalue=1, offvalue=0) 
questionOneAnswerOne.grid(column = 0, row = 1)
questionOneAnswerOneValue = questionOneInfo[0] 
questionOneAnswerTwo = Checkbutton(root, text = questionOneInfo[1], variable=qOneATwo, onvalue=1, offvalue=0)
questionOneAnswerTwo.grid(column = 0, row = 2)
questionOneAnswerTwoValue = questionOneInfo[1]
questionOneAnswerThree = Checkbutton(root, text = questionOneInfo[2], variable=qOneAThree, onvalue=1, offvalue=0)
...
questionTwoLabel = Label(root, text = promptList[1])
...
questionTwoAnswerOne = Checkbutton(root, text = questionTwoInfo[0], variable=qTwoAOne)
questionTwoAnswerOne.grid(column = 0, row = 7)
questionTwoAnswerOneValue = questionTwoInfo[0]
questionTwoAnswerTwo = Checkbutton(root, text = questionTwoInfo[1], variable=qTwoATwo)
questionTwoAnswerTwo.grid(column = 0, row = 8)
questionTwoAnswerTwoValue = questionTwoInfo[1]
questionTwoAnswerThree = Checkbutton(root, text = questionTwoInfo[2], variable=qTwoAThree)
...
questionThreeLabel = Label(root, text = promptList[2])
...
questionThreeAnswerOne = Checkbutton(root, text = questionThreeInfo[0], variable=qThreeAOne)
questionThreeAnswerOne.grid(column = 0, row = 13)
questionThreeAnswerOneValue = questionThreeInfo[0]
questionThreeAnswerTwo = Checkbutton(root, text = questionThreeInfo[1], variable=qThreeATwo)
questionThreeAnswerTwo.grid(column = 0, row = 14)
questionThreeAnswerTwoValue = questionThreeInfo[1]
questionThreeAnswerThree = Checkbutton(root, text = questionThreeInfo[2], variable=qThreeAThree)
...
questionFourLabel = Label(root, text = promptList[3])
...
questionFourAnswerOne = Checkbutton(root, text = questionFourInfo[0], variable=qFourAOne)
questionFourAnswerOne.grid(column = 0, row = 19)
questionFourAnswerOneValue = questionFourInfo[0]
questionFourAnswerTwo = Checkbutton(root, text = questionFourInfo[1], variable=qFourATwo)
questionFourAnswerTwo.grid(column = 0, row = 20)
questionFourAnswerTwoValue = questionFourInfo[1]
questionFourAnswerThree = Checkbutton(root, text = questionFourInfo[2], variable=qFourAThree)
